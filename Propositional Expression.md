...
- For any $P, Q \in \mathcal{F}$, contains:
	...
	- $(P \rightarrow Q)$
	- $(P \leftrightarrow Q)$
By this definition, $P \land Q$ and $P \lor \lnot Q \lor P \land Q$ are not expressions because they are missing the parentheses. I will however be ommitting the 